    ...
    <div className="bg-green-700 text-white h-dvh flex justify-center items-center">
      <div className="text-center">
        ...
        <Image
          ...
          width={500}
          height={500}
          className="w-36 h-36 rounded-full mx-auto border-4 border-white overflow-hidden bg-center bg-cover"
        />

        {/* Handler */}
        <h2 className="text-3xl font-bold mt-4">@jd29</h2>

        {/* Quote */}
        <p className="text-lg italic mt-2 mx-2">
          {/* generate a quote fo me thats inspirational to developers */}
        ...
        <div className="flex justify-center mt-4">
          ...
          <Link href="https://twitter.com/JKDRISC" className="mx-2 text-2xl">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              width={32}
          ...
          <Link href="https://github.com/jdriscoll98" className="mx-2 text-2xl">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 496 512"
              width={32}
        ...
        {/* Blog Link */}
        <div className="mt-4">
          <Link className="underline" href="/blog">View My Blog</Link>
        </div>
      </div>
    </div>
  );
